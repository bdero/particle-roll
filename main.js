...
//${METADATA_BEGIN}
var META_DATA="[graphics/circle.png];type=image/png;width=30;height=30;\n[mojo_font.png];type=image/png;width=864;height=13;\n[sounds/effects/blip1.mp3];type=audio/mpeg;\n[sounds/effects/blip1.ogg];type=audio/ogg;length=1108;hertz=22050;\n[sounds/effects/blip1.wav];type=audio/x-wav;length=1108;hertz=22050;\n[sounds/effects/blip2.mp3];type=audio/mpeg;\n[sounds/effects/blip2.ogg];type=audio/ogg;length=1013;hertz=22050;\n[sounds/effects/blip2.wav];type=audio/x-wav;length=1013;hertz=22050;\n[sounds/effects/blip3.mp3];type=audio/mpeg;\n[sounds/effects/blip3.ogg];type=audio/ogg;length=794;hertz=22050;\n[sounds/effects/blip3.wav];type=audio/x-wav;length=794;hertz=22050;\n[sounds/effects/blip4.mp3];type=audio/mpeg;\n[sounds/effects/blip4.ogg];type=audio/ogg;length=1365;hertz=22050;\n[sounds/effects/blip4.wav];type=audio/x-wav;length=1365;hertz=22050;\n[sounds/effects/blip5.mp3];type=audio/mpeg;\n[sounds/effects/blip5.ogg];type=audio/ogg;length=1413;hertz=22050;\n[sounds/effects/blip5.wav];type=audio/x-wav;length=1413;hertz=22050;\n[sounds/effects/bump1.ogg];type=audio/ogg;length=3072;hertz=44100;\n[sounds/effects/bump1.wav];type=audio/x-wav;length=3072;hertz=44100;\n[sounds/effects/bump2.ogg];type=audio/ogg;length=3072;hertz=44100;\n[sounds/effects/bump2.wav];type=audio/x-wav;length=3072;hertz=44100;\n[sounds/effects/bump3.ogg];type=audio/ogg;length=3072;hertz=44100;\n[sounds/effects/bump3.wav];type=audio/x-wav;length=3072;hertz=44100;\n[sounds/effects/bump4.ogg];type=audio/ogg;length=3072;hertz=44100;\n[sounds/effects/bump4.wav];type=audio/x-wav;length=3072;hertz=44100;\n[sounds/effects/bump5.ogg];type=audio/ogg;length=3072;hertz=44100;\n[sounds/effects/bump5.wav];type=audio/x-wav;length=3072;hertz=44100;\n[sounds/effects/explodelarge1.ogg];type=audio/ogg;length=45316;hertz=44100;\n[sounds/effects/explodelarge1.wav];type=audio/x-wav;length=45316;hertz=44100;\n[sounds/effects/explodelarge2.ogg];type=audio/ogg;length=45220;hertz=44100;\n[sounds/effects/explodelarge2.wav];type=audio/x-wav;length=45220;hertz=44100;\n[sounds/effects/explodelarge3.ogg];type=audio/ogg;length=48809;hertz=44100;\n[sounds/effects/explodelarge3.wav];type=audio/x-wav;length=48809;hertz=44100;\n[sounds/effects/explodelarge4.ogg];type=audio/ogg;length=42574;hertz=44100;\n[sounds/effects/explodelarge4.wav];type=audio/x-wav;length=42574;hertz=44100;\n[sounds/effects/explodelarge5.ogg];type=audio/ogg;length=50613;hertz=44100;\n[sounds/effects/explodelarge5.wav];type=audio/x-wav;length=50613;hertz=44100;\n[sounds/effects/explodemedium1.ogg];type=audio/ogg;length=30395;hertz=44100;\n[sounds/effects/explodemedium1.wav];type=audio/x-wav;length=30395;hertz=44100;\n[sounds/effects/explodemedium2.ogg];type=audio/ogg;length=35711;hertz=44100;\n[sounds/effects/explodemedium2.wav];type=audio/x-wav;length=35711;hertz=44100;\n[sounds/effects/explodemedium3.ogg];type=audio/ogg;length=31778;hertz=44100;\n[sounds/effects/explodemedium3.wav];type=audio/x-wav;length=31778;hertz=44100;\n[sounds/effects/explodemedium4.ogg];type=audio/ogg;length=29097;hertz=44100;\n[sounds/effects/explodemedium4.wav];type=audio/x-wav;length=29097;hertz=44100;\n[sounds/effects/explodemedium5.ogg];type=audio/ogg;length=30573;hertz=44100;\n[sounds/effects/explodemedium5.wav];type=audio/x-wav;length=30573;hertz=44100;\n[sounds/effects/explodesmall1.ogg];type=audio/ogg;length=14997;hertz=44100;\n[sounds/effects/explodesmall1.wav];type=audio/x-wav;length=14997;hertz=44100;\n[sounds/effects/explodesmall2.ogg];type=audio/ogg;length=15020;hertz=44100;\n[sounds/effects/explodesmall2.wav];type=audio/x-wav;length=15020;hertz=44100;\n[sounds/effects/explodesmall3.ogg];type=audio/ogg;length=18856;hertz=44100;\n[sounds/effects/explodesmall3.wav];type=audio/x-wav;length=18856;hertz=44100;\n[sounds/effects/explodesmall4.ogg];type=audio/ogg;length=14965;hertz=44100;\n[sounds/effects/explodesmall4.wav];type=audio/x-wav;length=14965;hertz=44100;\n[sounds/effects/explodesmall5.ogg];type=audio/ogg;length=14997;hertz=44100;\n[sounds/effects/explodesmall5.wav];type=audio/x-wav;length=14997;hertz=44100;\n[sounds/effects/hit1.mp3];type=audio/mpeg;\n[sounds/effects/hit1.ogg];type=audio/ogg;length=12837;hertz=22050;\n[sounds/effects/hit1.wav];type=audio/x-wav;length=12837;hertz=22050;\n[sounds/effects/hit2.mp3];type=audio/mpeg;\n[sounds/effects/hit2.ogg];type=audio/ogg;length=12045;hertz=22050;\n[sounds/effects/hit2.wav];type=audio/x-wav;length=12045;hertz=22050;\n[sounds/effects/hit3.mp3];type=audio/mpeg;\n[sounds/effects/hit3.ogg];type=audio/ogg;length=13564;hertz=22050;\n[sounds/effects/hit3.wav];type=audio/x-wav;length=13564;hertz=22050;\n[sounds/effects/hit4.mp3];type=audio/mpeg;\n[sounds/effects/hit4.ogg];type=audio/ogg;length=12637;hertz=22050;\n[sounds/effects/hit4.wav];type=audio/x-wav;length=12637;hertz=22050;\n[sounds/effects/hit5.mp3];type=audio/mpeg;\n[sounds/effects/hit5.ogg];type=audio/ogg;length=12558;hertz=22050;\n[sounds/effects/hit5.wav];type=audio/x-wav;length=12558;hertz=22050;\n";
...
function bb_framework_new(){
	...
	this.bb_images=bb_framework_new6.call(new bb_framework_ImageBank);
	this.bb_sounds=bb_framework_new8.call(new bb_framework_SoundBank);
...
bb_framework_DiddyApp.prototype.bbm_ReadInputs=function(){
	this.bb_mouseX=((bb_input_MouseX()/bb_framework_SCREENX_RATIO)|0);
	this.bb_mouseY=((bb_input_MouseY()/bb_framework_SCREENY_RATIO)|0);
...
bb_main_Game.prototype.bbm_LoadImages=function(){
	this.bb_images.bbm_Load2("circle.png","",true,false);
}
bb_main_Game.prototype.bbm_LoadSFX=function(){
	var bbt_sfxNames=["bump","explodesmall","explodemedium","explodelarge"];
	...
	for(var bbt_i=0;bbt_i<bb_sound_sfxRepo.length;bbt_i=bbt_i+1){
		...
		for(var bbt_j=0;bbt_j<bb_sound_sfxRepo[bbt_i].length;bbt_j=bbt_j+1){
			...
			this.bb_sounds.bbm_Load4("effects/"+bbt_name,"",false);
...
bb_framework_ImageBank.prototype.bbm_Load2=function(bbt_name,bbt_nameoverride,bbt_midhandle,bbt_ignoreCache){
	...
	if(this.bbm_Contains(bb_boxes_new3.call(new bb_boxes_StringObject,bbt_storeKey))){
		this.bbm_Get(bb_boxes_new3.call(new bb_boxes_StringObject,bbt_storeKey)).bb_image.bbm_Discard();
	}
	var bbt_i=bb_framework_new5.call(new bb_framework_GameImage);
	bbt_i.bbm_Load(this.bb_path+bbt_name,bbt_midhandle);
	bbt_i.bb_name=bbt_storeKey;
	this.bbm_Set((bb_boxes_new3.call(new bb_boxes_StringObject,bbt_i.bb_name)),bbt_i);
	return bbt_i;
}
...
function bb_graphics_LoadImage(bbt_path,bbt_frameCount,bbt_flags){
	return (bb_graphics_new3.call(new bb_graphics_Image)).bbm_Load5(bbt_path,bbt_frameCount,bbt_flags);
}
...
function bb_framework_Cache(){
	for(var bbt_i=0;bbt_i<=bb_framework_MAX_PARTICLES-1;bbt_i=bbt_i+1){
		bb_framework_particles[bbt_i]=bb_framework_new13.call(new bb_framework_Particle);
	}
}
...
bb_gamescreen_GameScreen.prototype.bbm_Start=function(){
	...
	this.bb_unitClock=bb_units_new11.call(new bb_units_UnitClock,bb_framework_SCREEN_WIDTH2,bb_framework_SCREEN_HEIGHT2,100.0,bb_framework_SCREEN_HEIGHT2*0.75,3,60,true,120,120,180);
...
bb_gamescreen_GameScreen.prototype.bbm_Update2=function(){
	...
	if(this.bb_collectCount!=this.bb_player.bb_bodySphere.bb_unitArray.length){
		this.bb_collectCount=this.bb_player.bb_bodySphere.bb_unitArray.length;
		this.bb_collectCountString.bbm_ResetString(String(this.bb_collectCount));
	}
...
bb_gamescreen_GameScreen.prototype.bbm_Render=function(){
	...
	bb_main_zom.bbm_Render();
	bb_graphics_SetAlpha(1.0);
	var bbt_=bb_main_wm.bb_entity;
	var bbt_2=0;
	while(bbt_2<bbt_.length){
		var bbt_entity=bbt_[bbt_2];
		bbt_2=bbt_2+1;
		var bbt_3=bb_main_wm.bb_collectable;
		var bbt_4=0;
		while(bbt_4<bbt_3.length){
			var bbt_collectable=bbt_3[bbt_4];
			bbt_4=bbt_4+1;
			bb_graphics_SetColor((bbt_collectable.bb_body.bb_r),(bbt_collectable.bb_body.bb_g),(bbt_collectable.bb_body.bb_b));
			bb_graphics_DrawLine(bbt_entity.bb_x,bbt_entity.bb_y,bbt_collectable.bb_x,bbt_collectable.bb_y);
		}
	}
	bb_graphics_SetColor(255.0,255.0,255.0);
...
bb_units_Unit.prototype.bbm_Update4=function(bbt_x,bbt_y,bbt_z,bbt_sizeRelative){
	...
	this.bb_y=bbt_y;
	this.bb_z=bbt_z;
	if(bbt_sizeRelative==true || bbt_z<=0.0){
		this.bb_a=100.0;
...
function bb_units_new3(bbt_x,bbt_y,bbt_z,bbt_size,bbt_r,bbt_g,bbt_b){
	...
	this.bbm_Update4(bbt_x,bbt_y,bbt_z,false);
	this.bb_r=bbt_r;
	this.bb_g=bbt_g;
	this.bb_b=bbt_b;
...
bb_units_Unit.prototype.bbm_Render=function(){
	...
	var bbt_drawX=this.bb_x+bb_random_Rnd2(-0.5,0.5);
	var bbt_drawY=this.bb_y+bb_random_Rnd2(-0.5,0.5);
	var bbt_drawRadius=this.bb_radius+bb_random_Rnd2(0.5,0.5);
...
bb_text_CharUnit.prototype.bbm_CharUpdate=function(){
	...
	this.bbm_Update4(bbt_newX,bbt_newY,this.bb_z,false);
...
bb_units_FlingUnit.prototype.bbm_FlingUpdate=function(){
	...
	bb_units_Unit.prototype.bbm_Update4.call(this,this.bb_realX,this.bb_realY,this.bb_z,false);
...
bb_world_Orb.prototype.bbm_Update2=function(){
	this.bb_body.bbm_Update4(this.bb_x,this.bb_y,this.bb_z,false);
}
...
bb_world_Entity.prototype.bbm_Collect=function(bbt_c){
	...
	if(bbt_c.bb_body.bb_r==255 && bbt_c.bb_body.bb_g==0 && bbt_c.bb_body.bb_b==0){
		if(this.bb_bodySphere.bb_unitArray.length<100){
			bb_sound_PlaySoundType(1);
		}else{
			if(this.bb_bodySphere.bb_unitArray.length<300){
				bb_sound_PlaySoundType(2);
			}else{
				bb_sound_PlaySoundType(3);
			}
		}
...
bb_units_SphereUnit.prototype.bbm_Reset3=function(){
	this.bbm_Update4(this.bb_cx+Math.sin((this.bb_inclination)*D2R)*Math.cos((this.bb_azimuth)*D2R)*this.bb_sphereRadius,this.bb_cy+Math.sin((this.bb_inclination)*D2R)*Math.sin((this.bb_azimuth)*D2R)*this.bb_sphereRadius,this.bb_cz+Math.cos((this.bb_inclination)*D2R)*this.bb_sphereRadius,false);
}
...
bb_units_SphereUnit.prototype.bbm_RotationUpdate=function(bbt_ncx,bbt_ncy,bbt_ncz,bbt_yaw,bbt_pitch,bbt_roll){
	...
	this.bbm_Update4(this.bb_cx+(bbt_deltaX*bbt_m11+bbt_deltaY*bbt_m21+bbt_deltaZ*bbt_m31),this.bb_cy+(bbt_deltaX*bbt_m12+bbt_deltaY*bbt_m22+bbt_deltaZ*bbt_m32),this.bb_cz+(bbt_deltaX*bbt_m13+bbt_deltaY*bbt_m23+bbt_deltaZ*bbt_m33),false);
}
function bb_units_UnitClock(){
	Object.call(this);
	this.bb_x=.0;
	this.bb_y=.0;
	this.bb_z=.0;
	...
	this.bb_b=0;
	this.bb_frame=null;
	this.bb_clockHandArray=[];
}
bb_units_UnitClock.prototype.bbm_AddClockHand=function(bbt_length,bbt_tickDivisor,bbt_tickRevolution,bbt_startDirection,bbt_direction,bbt_unitNum,bbt_r,bbt_g,bbt_b){
	this.bb_clockHandArray=resize_object_array(this.bb_clockHandArray,this.bb_clockHandArray.length+1);
	this.bb_clockHandArray[this.bb_clockHandArray.length-1]=bb_units_new17.call(new bb_units_UnitClockHand,this.bb_x,this.bb_y,this.bb_z,this.bb_timer,bbt_length,bbt_tickDivisor,bbt_tickRevolution,bbt_startDirection,bbt_direction,bbt_unitNum,-1.0,bbt_r,bbt_g,bbt_b);
}
function bb_units_new11(bbt_x,bbt_y,bbt_z,bbt_radius,bbt_hands,bbt_tickFrames,bbt_active,bbt_r,bbt_g,bbt_b){
	this.bb_x=bbt_x;
	this.bb_y=bbt_y;
	this.bb_z=bbt_z;
	this.bb_timer=bb_essentials_new3.call(new bb_essentials_Timer,bbt_tickFrames,bbt_active);
	this.bb_r=bbt_r;
	this.bb_g=bbt_g;
	this.bb_b=bbt_b;
	this.bb_frame=bb_units_new13.call(new bb_units_UnitCircle,bbt_x,bbt_y,bbt_z,bbt_radius,0.0,60,-1.0,bbt_r,bbt_g,bbt_b);
	var bbt_maxUnitNum=9;
	var bbt_frameUnitRadius=this.bb_frame.bb_unitArray[0].bb_radius;
	var bbt_maxLength=this.bb_frame.bb_radius-bbt_frameUnitRadius;
	var bbt_handUnitRadiusNum=bbt_maxUnitNum*2-1;
	var bbt_handUnitRadius=bbt_maxLength/(bbt_handUnitRadiusNum);
	for(var bbt_i=1;bbt_i<=bbt_hands;bbt_i=bbt_i+1){
		var bbt_tickDivisor=0;
		var bbt_=bbt_i;
		if(bbt_==1){
			bbt_tickDivisor=1;
		}else{
		...
		this.bbm_AddClockHand(bbt_handUnitRadius*(bbt_handUnitRadiusNum-1-(bbt_i-1)*2),bbt_tickDivisor,60,0.0,0.0,bbt_maxUnitNum-(bbt_i-1),bbt_r+bbt_i*10,bbt_g+bbt_i*10,bbt_b+10-bbt_i*10);
	}
	return this;
}
...
bb_units_UnitClock.prototype.bbm_Update2=function(){
	this.bb_timer.bbm_Update2();
	this.bb_frame.bbm_Update2();
	var bbt_=this.bb_clockHandArray;
	var bbt_2=0;
	while(bbt_2<bbt_.length){
		var bbt_clockHand=bbt_[bbt_2];
		bbt_2=bbt_2+1;
		bbt_clockHand.bbm_Update2();
	}
	if(this.bb_frame.bb_direction/2.0!=this.bb_clockHandArray[0].bb_direction){
		this.bb_frame.bbm_SetDirection(this.bb_clockHandArray[0].bb_direction*2.0);
	}
}
...
bb_units_UnitCircle.prototype.bbm_GenerateCircle=function(bbt_unitNum,bbt_unitSize){
	...
	for(var bbt_i=0;bbt_i<=bbt_unitNum-1;bbt_i=bbt_i+1){
		...
		this.bb_unitArray[bbt_i]=bb_units_new15.call(new bb_units_CircleUnit,this.bb_x,this.bb_y,this.bb_z,bbt_unitRadius,this.bb_radius,bbt_unitDirection,5.0,this.bb_r,this.bb_g,this.bb_b,bbt_sizeRelative);
	}
}
function bb_units_new13(bbt_x,bbt_y,bbt_z,bbt_radius,bbt_direction,bbt_unitNum,bbt_unitSize,bbt_r,bbt_g,bbt_b){
	this.bb_x=bbt_x;
	this.bb_y=bbt_y;
	this.bb_z=bbt_z;
	this.bb_direction=bbt_direction;
...
bb_units_UnitCircle.prototype.bbm_SetDirection=function(bbt_direction){
	var bbt_=this.bb_unitArray;
	var bbt_2=0;
	while(bbt_2<bbt_.length){
		var bbt_unit=bbt_[bbt_2];
		bbt_2=bbt_2+1;
		bbt_unit.bbm_SetDirection(bbt_direction);
	}
}
...
bb_units_CircleUnit.prototype.bbm_CircleUpdate=function(){
	...
	bb_units_Unit.prototype.bbm_Update4.call(this,this.bb_centerX+Math.sin((this.bb_direction)*D2R)*this.bb_distance,this.bb_centerY-Math.cos((this.bb_direction)*D2R)*this.bb_distance,this.bb_centerZ,this.bb_sizeRelative);
}
function bb_units_new15(bbt_centerX,bbt_centerY,bbt_centerZ,bbt_size,bbt_distance,bbt_direction,bbt_divisor,bbt_r,bbt_g,bbt_b,bbt_sizeRelative){
	bb_units_new4.call(this);
...
function bb_units_new16(){
	bb_units_new4.call(this);
	return this;
}
function bb_units_UnitClockHand(){
	Object.call(this);
	this.bb_timer=null;
	this.bb_tickRevolution=0;
	this.bb_tickDivisor=0;
	this.bb_tickModifier=0;
	this.bb_x=.0;
	this.bb_y=.0;
	this.bb_z=.0;
	this.bb_length=.0;
...
bb_units_UnitClockHand.prototype.bbm_SetDirection=function(bbt_direction){
	this.bb_direction=bbt_direction;
	var bbt_=this.bb_unitArray;
	var bbt_2=0;
	while(bbt_2<bbt_.length){
		var bbt_unit=bbt_[bbt_2];
		bbt_2=bbt_2+1;
		bbt_unit.bbm_SetDirection(this.bb_startDirection+bbt_direction);
	}
}
bb_units_UnitClockHand.prototype.bbm_GenerateClockHand=function(bbt_unitNum,bbt_unitSize){
	this.bb_unitArray=resize_object_array(this.bb_unitArray,bbt_unitNum);
	var bbt_unitRadius=.0;
	var bbt_sizeRelative=false;
	if(bbt_unitSize==-1.0){
		bbt_sizeRelative=true;
		bbt_unitRadius=this.bb_length/((bbt_unitNum-1)*2);
	}else{
		bbt_sizeRelative=false;
		bbt_unitRadius=bbt_unitSize;
	}
	var bbt_unitDistance=.0;
	for(var bbt_i=0;bbt_i<=bbt_unitNum-1;bbt_i=bbt_i+1){
		bbt_unitDistance=bbt_unitRadius*(bbt_i)*2.0;
		this.bb_unitArray[bbt_i]=bb_units_new15.call(new bb_units_CircleUnit,this.bb_x,this.bb_y,this.bb_z,bbt_unitRadius,bbt_unitDistance,0.0,5.0,this.bb_r,this.bb_g,this.bb_b,bbt_sizeRelative);
	}
	this.bbm_SetDirection(this.bb_direction);
}
function bb_units_new17(bbt_x,bbt_y,bbt_z,bbt_timer,bbt_length,bbt_tickDivisor,bbt_tickRevolution,bbt_startDirection,bbt_direction,bbt_unitNum,bbt_unitSize,bbt_r,bbt_g,bbt_b){
	this.bb_timer=bbt_timer;
	this.bb_tickRevolution=bbt_tickRevolution;
	this.bb_tickDivisor=bbt_tickDivisor;
	this.bb_tickModifier=this.bb_tickModifier;
	this.bb_x=bbt_x;
	this.bb_y=bbt_y;
	this.bb_z=bbt_z;
	this.bb_length=bbt_length;
	this.bb_startDirection=bbt_startDirection;
	this.bb_direction=bbt_direction;
	this.bb_r=bbt_r;
	this.bb_g=bbt_g;
	this.bb_b=bbt_b;
	this.bbm_GenerateClockHand(bbt_unitNum,bbt_unitSize);
	return this;
}
function bb_units_new18(){
	return this;
}
bb_units_UnitClockHand.prototype.bbm_Update2=function(){
	if(this.bb_timer.bb_ticking){
		this.bbm_SetDirection(((360/this.bb_tickRevolution)|0)*Math.floor((this.bb_timer.bb_ticks/this.bb_tickDivisor)|0));
	}
	var bbt_=this.bb_unitArray;
	var bbt_2=0;
	while(bbt_2<bbt_.length){
...
bb_collections_ICollection.prototype.bbm_ToArray=function(){
}
bb_collections_ICollection.prototype.bbm_Add2=function(bbt_o){
}
...
function bb_graphics_DrawLine(bbt_x1,bbt_y1,bbt_x2,bbt_y2){
	bb_graphics_ValidateMatrix();
	bb_graphics_renderDevice.DrawLine(bbt_x1,bbt_y1,bbt_x2,bbt_y2);
	return 0;
}
